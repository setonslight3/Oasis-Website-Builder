      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-emerald-500 bg-clip-text text-transparent">SYNAPSE</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-sm text-gray-600">hello@synapse.edu.ng</li>
